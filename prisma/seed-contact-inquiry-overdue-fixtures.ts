...
const legacyPublicIds = [
  "DCM-20260809-O000000001",
  "DCM-20260809-O000000002",
  "DCM-20260809-O000000003",
  "DCM-20260809-O000000004",
  "DCM-20260809-O000000005",
  "DCM-20260809-O000000006"
];
...
const fixtures: Fixture[] = [
  { publicId: "DCM-20260809-A000000001", category: "BUG", status: "OPEN", subject: `${seedPrefix} 未対応・48時間経過`, createdMinutesAgo: 48 * 60, updatedMinutesAgo: 5, assigned: false },
  { publicId: "DCM-20260809-A000000002", category: "HOW_TO", status: "OPEN", subject: `${seedPrefix} 未対応・24時間経過`, createdMinutesAgo: 24 * 60, updatedMinutesAgo: 120, assigned: false },
  { publicId: "DCM-20260809-A000000003", category: "FEATURE_REQUEST", status: "OPEN", subject: `${seedPrefix} 未対応・22時間経過`, createdMinutesAgo: 22 * 60, updatedMinutesAgo: 1, assigned: false },
  { publicId: "DCM-20260809-A000000004", category: "ACCOUNT", status: "IN_PROGRESS", subject: `${seedPrefix} 確認中・72時間経過`, createdMinutesAgo: 72 * 60, updatedMinutesAgo: 10, assigned: true },
  { publicId: "DCM-20260809-A000000005", category: "OTHER", status: "WAITING_FOR_USER", subject: `${seedPrefix} 回答待ち・72時間経過`, createdMinutesAgo: 72 * 60, updatedMinutesAgo: 15, assigned: true },
  { publicId: "DCM-20260809-A000000006", category: "BUG", status: "RESOLVED", subject: `${seedPrefix} 対応済み・72時間経過`, createdMinutesAgo: 72 * 60, updatedMinutesAgo: 20, assigned: true }
];
